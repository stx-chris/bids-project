...
top_enrichment_plot <- function(ds, title) {
  ...
  enrichment_up_sora$Term <- gsub("HALLMARK_", "", enrichment_up_sora$Term)
...
enrichment_up_tram$Term <- gsub("HALLMARK_", "", enrichment_up_tram$Term)
...
enrichment_down_sora$Term <- gsub("HALLMARK_", "", enrichment_down_sora$Term)
...
enrichment_down_tram$Term <- gsub("HALLMARK_", "", enrichment_down_tram$Term)
